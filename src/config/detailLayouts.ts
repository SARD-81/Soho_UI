...
export const SHARE_DETAIL_LAYOUT: DetailLayoutConfig = {
  ...
  excludedKeys: ['is_custom', 'inherit permissions', 'inherit_permissions', 'guest ok', 'guest_ok'],
  sections: [
    {
      id: 'general',
      title: 'مشخصات کلی',
    ...
    },
    {
      id: 'limits',
      title: 'محدودیت‌ها',
      keys: ['max_connections', 'max connections', 'create_mask', 'create mask', 'directory_mask', 'directory mask'],
      optional: true,
    },
  ],
};
