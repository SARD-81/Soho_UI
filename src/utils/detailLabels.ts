...
const NORMALIZED_KEY_LABELS: Record<string, string> = {
  ...
  clients: 'کلاینت‌ها',
  options: 'گزینه‌ها',
  read_write: 'دسترسی خواندن و نوشتن',
  rw: 'دسترسی خواندن و نوشتن',
  sync: 'نوشتن همگام روی دیسک',
  async: 'نوشتن ناهمگام روی دیسک',
  root_squash: 'محدودسازی دسترسی ریشه',
  all_squash: 'محدودسازی همه کاربران',
  insecure: 'اتصال ناامن',
  'no_subtree_check': 'عدم بررسی زیرشاخه',
};
