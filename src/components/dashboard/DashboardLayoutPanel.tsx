    ...
    >
      ...
      >
        <Typography variant="body2" color="text.secondary">
          ویجت‌ها را فعال یا غیرفعال کنید و اندازه نمایش هر بخش را برای نیاز خود
          تنظیم نمایید. ترتیب نمایش از طریق کشیدن و رها کردن در صفحه داشبورد
          قابل مدیریت است.
        </Typography>
        {widgets.map((widget) => {
          ...
          return (
            ...
            >
              ...
              >
                <Box>
                  <Typography variant="subtitle1" sx={{ fontWeight: 600 , color : 'var(--color-primary)' }}>
                    {widget.title}
                  </Typography>
                  {widget.description ? (
                    ...
                    >
                      ...
                      >
                        <Stack direction="row" alignItems="center" gap={1}>
                          <Typography
                            variant="body2"
                            sx={{ fontWeight: option.isDefault ? 600 : 500 , color : 'var(--color-text)' }}
                          >
                            {option.label}
                          </Typography>
                          {option.isDefault ? (
