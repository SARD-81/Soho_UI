...
interface WebUserPasswordModalProps {
  open: boolean;
  username: string | null;
  onClose: () => void;
  onSubmit: (payload: UpdateWebUserPasswordPayload) => void;
  isSubmitting: boolean;
  errorMessage: string | null;
}

const WebUserPasswordModal = ({
  open,
  username,
  onClose,
  onSubmit,
...
export default WebUserPasswordModal;
